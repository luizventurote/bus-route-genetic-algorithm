...
// Bus variables
$bus->setBuses( $_GET['qty_bus'] );
$bus->setMaxEmployees( $_GET['qty_emp'] );
$bus->setMaxDistance( $_GET['max_dist'] );

// Build genetic algorithm
$ga = new GeneticAlgorithm($map, $bus);

// GA variables
$ga->setPopulationSize( $_GET['pop_size'] );
$ga->setQtyMaxGeneration( $_GET['qty_gen'] );
...
<div class="page">
    ...
    <div class="container">
        ...
        <div class="btn-box">
            <a href="index.php" class="btn btn-large">Restart algorithm</a>
        </div>
